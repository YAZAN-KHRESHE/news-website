...
$result = $con->query("SELECT * FROM data WHERE browser='since' ORDER BY id DESC") ;
$index = [];
...
<body>
    ...
    <div class="landing" id="landing" style="background-image: url(img/خريطه.jpg) ;
...
<?php 
$con = mysqli_connect('localhost','root','','newspage') ;
$req = "SELECT Lname FROM data WHERE browser='since' ORDER BY id DESC  " ; 
